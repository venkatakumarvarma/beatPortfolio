...
/* Devicon CDN icons (fast & free). Add/remove as you like. */
const techIcons = [
...
function Bubble({ name, url, i }) {
  return (
    <motion.div
      ...
      style={{ zIndex: 10 + i }}
    >
      <img src={url} alt={name} className="w-7 h-7 md:w-8 md:h-8 object-contain" />
    </motion.div>
  );
}

/* Honeycomb: CSS grid + row offsets to mimic Apple Watch bubble feel */
